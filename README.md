...
Gearcoleco is a very accurate cross-platform ColecoVision and Pencil II emulator written in C++ that runs on Windows, macOS, Linux, BSD, Raspberry Pi and RetroArch.
